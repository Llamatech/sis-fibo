   ...
   CREATE TABLE USUARIO
	...
	CREATE VIEW SCHEMA_CONS AS
SELECT * FROM (SELECT u.TABLE_NAME, u.CONSTRAINT_NAME AS CONS_NAME, u.COLUMN_NAME, v.CONSTRAINT_TYPE, v.SEARCH_CONDITION, v.R_CONSTRAINT_NAME FROM
            (SELECT * FROM USER_CONS_COLUMNS) u
            INNER JOIN
            (SELECT * FROM USER_CONSTRAINTS) v
            ON u.CONSTRAINT_NAME = v.CONSTRAINT_NAME) w
            LEFT OUTER JOIN
            (SELECT CONSTRAINT_NAME, TABLE_NAME AS TAB_REF, COLUMN_NAME AS COL_REF FROM USER_CONS_COLUMNS) z
            ON w.R_CONSTRAINT_NAME = z.CONSTRAINT_NAME
